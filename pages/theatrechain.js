...
import TheatreChainContainer from '../components/crm-dashboard/theatres/theatrechainContainer'
import { Router } from '../routes'
import { Provider } from 'react-redux'
import { initStore } from '../store'
import reducers from '../reducers/index.js'
import { getTheatreChain } from '../actions/theatreActions'
    ...
    static async getInitialProps (args) {
        ...
        if (process.env.DEBUG || (!isServer)) {
            ...
            if (typeof localStorage.getItem('key') !== 'undefined') {
                ...
                await  store.dispatch(getTheatreChain(contentHeaders))
            }
        }
