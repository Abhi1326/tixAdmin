...
import { getMovieOrderDetail } from '../actions/moveOrderActions'
import { contentHeaders } from '../components/common/headers'
import PerOrderReportContainer from '../components/cinema-dashboard/per-order-transaction/perOrderReportContainer'
  ...
  static async getInitialProps (args) {
    ...
    if (process.env.DEBUG || (!isServer)) {
      if (typeof localStorage.getItem('key') !== 'undefined') {
        ...
        await store.dispatch(getMovieOrderDetail(contentHeaders))
      }
    } else {
  ...
  render () {
    ...
    return (
      ...
      <Provider store={this.store}>
        ...
        <PerOrderReportContainer movieOrder={this.props.initialstate.data.movieOrderDetail || {}}
